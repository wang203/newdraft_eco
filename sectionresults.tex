...
%{\small{
\begin{center}
\includegraphics[width=0.22\textwidth,clip,trim=0.4in 0 0.8in 0]{figure/PR-snow.jpg}
\includegraphics[width=0.22\textwidth,clip,trim=0.4in 0 0.8in 0]{figure/PR-nonsnow.jpg}
\end{center}
%}}
\vspace{-12pt}
...
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetposi/6.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetposi/7.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetposi/8.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetposi/9.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetposi/10.jpg} \\
\multicolumn{5}{c}{(a) Random positive images in vegetation dataset} \\ 
\\[-6pt]
\hline
\\[-6pt]
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetnega/6.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetnega/7.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetnega/8.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetnega/9.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/datasetnega/10.jpg} \\
...
\begin{center}
\begin{tabular}{@{}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}c@{\,\,\,}}
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/6.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/7.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/8.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/9.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/10.jpg} \\
%\multicolumn{5}{c}{(a) Random positive images in vegetation dataset} \\ 
\\[-6pt]
\hline
\\[-6pt]
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/16.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/17.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/18.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/19.jpg} &
\includegraphics[width=0.08\textwidth, height=0.5in]{imggrid/falseposi/20.jpg} \\
%\multicolumn{5}{c}{(b) Random negative images in vegetation dataset} \\
\end{tabular}
\end{center}
}}
