...
%\fxnote{a word for ``more and more popular''} 
...
%, and straight forward \fxnote{I just want to say easy.} to identify by human. 
...
%\fxnote{like vegetation case, satellite data miss data at almost all of the transition period}. 
%In this case, our results are very helpful for ecologists especially when 
%the data during changing or transition period is all they need. \fxnote{is this clear?}
...
%\fxnote{misleading of words describing vegetation}
, it works less satisfactory on vegetation coverage estimation.

\input{sectionintro}
%\input{sectionrelatedwork}
