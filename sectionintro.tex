...
\includegraphics[width=0.1\textwidth, height=0.7in]{image/citysnow.jpg} &
\includegraphics[width=0.1\textwidth, height=0.7in]{image/citysnow2.jpg} &
\includegraphics[width=0.1\textwidth, height=0.7in]{image/dogsnow.jpg} &
\includegraphics[width=0.1\textwidth, height=0.7in]{image/humansnow.jpg} \\
%\multicolumn{5}{c}{(a) Random positive images in vegetation dataset} \\ 
\\[-6pt]
\hline
\\[-6pt]
\includegraphics[width=0.1\textwidth, height=0.7in]{image/intentiongreen.jpg} &
\includegraphics[width=0.1\textwidth, height=0.7in]{image/waterfallgreen.jpg} &
\includegraphics[width=0.1\textwidth, height=0.7in]{image/dogtree.jpg} &
