...
The idea of reproducing satellite maps has become more and more interesting to scientists applying textual mining on~\cite{bollen11twitter,ecology2012www,you2015multifacetedelections,wood2013usingtourism} \fxnote{fixed,  cite{stock, ecology, election, tourists} }, 
and recently to computer vision researches directly deriving~\cite{murdock} \fxnote{cloud is fixed, cite{temperature, cloud, mountain peak}} information from visual content.
